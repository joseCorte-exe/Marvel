                ...
                <main>
                    <section id='top'>
                        ...
                        <article>
                            <h4>Criadores:</h4>
                            {
                                details.creators==[]? details.creators[0]==undefined? <span>Creators not avaliable</span>  : details.creators.map(value => (<span key={value} >{`${value}, `}</span>)) : <p>'Marvel'</p>
                            }
                            {
                        ...
                        <div id='cardContainer'>
                                {
                                    characters[0]==undefined? <p>Characters not avaliable</p> : characters.map(value =>  <Card key={value.id} id={value.id} image={value.thumbnail.path}
                                        ...
                                        creators={''} route={`/characters/${value.id}`} /> )
                                }
                        </div>
                    </section>
